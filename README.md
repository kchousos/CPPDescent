...
| `-q` |               | For "quiet". If this flag is set, then the output is a line of comma separated values. Mainly used for automating experiments with the [corresponding script](./CPPDescent/blob/master/experiments.sh). |
